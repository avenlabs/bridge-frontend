...
export const fetchTokenLimits = async (
  ...
  try {
    ...
    // console.log(123, minPerTx, fromTokenAddress, fromMediatorContract, isDedicatedMediatorToken)
...
export const relayTokens = async (
  ...
  receiver,
  amount,
  { shouldReceiveNativeCur, foreignChainId, homeChainId },
) => {
  ...
  switch (mode) {
    ...
    case 'erc677': {
      ...
      const foreignHelperContract = getHelperContract(foreignChainId, homeChainId);
      const bytesData =
